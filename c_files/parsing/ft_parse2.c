...
/*   Updated: 2025/03/04 08:42:12 by ilevy            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_parse2_assign_texture_to_data(char *path, int num, t_data *data)
{
	if (num == NORTH)
	{
		...
		data->north_txt->img = mlx_xpm_file_to_image(data->mlx->mlx, data->north_txt->path_to_xpm, &data->north_txt->width, &data->north_txt->height);
		if (!data->north_txt->img)
			return(ft_printf(2, "Error\nTexture loading failure\n"), ERROR);
		data->north_txt->addr = mlx_get_data_addr(data->north_txt->img, &data->north_txt->bpp, &data->north_txt->s_l, &data->north_txt->e);
	}
	else if (num == SOUTH)
	{
		...
		data->south_txt->img = mlx_xpm_file_to_image(data->mlx->mlx, data->south_txt->path_to_xpm, &data->south_txt->width, &data->south_txt->height);
		if (!data->south_txt->img)
			return(ft_printf(2, "Error\nTexture loading failure\n"), ERROR);
		data->south_txt->addr = mlx_get_data_addr(data->south_txt->img, &data->south_txt->bpp, &data->south_txt->s_l, &data->south_txt->e);
	}
	else if (num == EAST)
	{
		...
		data->east_txt->img = mlx_xpm_file_to_image(data->mlx->mlx, data->east_txt->path_to_xpm, &data->east_txt->width, &data->east_txt->height);
		if (!data->east_txt->img)
			return(ft_printf(2, "Error\nTexture loading failure\n"), ERROR);
		data->east_txt->addr = mlx_get_data_addr(data->east_txt->img, &data->east_txt->bpp, &data->east_txt->s_l, &data->east_txt->e);
	}
	else if (num == WEST)
	{
		...
		data->west_txt->img = mlx_xpm_file_to_image(data->mlx->mlx, data->west_txt->path_to_xpm, &data->west_txt->width, &data->west_txt->height);
		if (!data->west_txt->img)
			return(ft_printf(2, "Error\nTexture loading failure\n"), ERROR);
		data->west_txt->addr = mlx_get_data_addr(data->west_txt->img, &data->west_txt->bpp, &data->west_txt->s_l, &data->west_txt->e);
	}
	return (0);
}
